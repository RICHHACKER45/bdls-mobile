...
import { settingsOutline, shieldCheckmarkOutline } from 'ionicons/icons';
  ...
  template: `
    ...
    <ion-content style="--background: #ffffff; color: #000000;">
      <div style="text-align: center; padding-top: 60px; color: #a3a3a3;">
        <ion-icon name="settings-outline" style="font-size: 64px; opacity: 0.3; color: #000000;"></ion-icon>
        <p style="font-weight: 600; font-size: 18px; color: #000000; margin-top: 16px;">Settings</p>
...
export class SettingsPage {
  constructor() {
    addIcons({ settingsOutline, shieldCheckmarkOutline });
  }
}